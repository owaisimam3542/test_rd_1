...
"""
    ...
    try:
        ...
        print("Error:", e)
        return {"reply": "Something went wrong on the server."}
...
Instructions:
- Suggest 3 to 5 personalized spiritual habits.
- Prefer JSON list format: ["Chant 'Om Namah Shivaya'", "Meditate at sunrise"]
- If not possible, reply as a bullet list or numbered list (one habit per line).
- Avoid extra explanations in parentheses.
"""
